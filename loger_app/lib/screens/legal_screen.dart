      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(child: Text("Application : Loger Sénégal", style: TextStyle(color: Colors.grey))),
            const SizedBox(height: 32),
            
            _buildSection(
              "1. ÉDITEUR DE L’APPLICATION",
              "L’application Loger Sénégal est éditée par :\n\n• Nom / Société : DigitalH\n• Adresse : Ouakam\n• Email : solvable@logersenegal.com\n• Téléphone : 76 444 33 13",
            ),
            
            _buildSection(
              "2. OBJET DE L’APPLICATION",
              "L’application Loger Sénégal est une plateforme numérique permettant :\n\n• De consulter des annonces immobilières (location, vente, colocation, etc.)\n• De publier des annonces immobilières\n• De mettre en relation les utilisateurs (bailleurs, agences, locataires, acheteurs)\n\n⚠️ Loger Sénégal agit uniquement comme intermédiaire technique et ne participe pas aux transactions entre utilisateurs.",
            ),
            ...
            _buildSection(
              "10. DROIT APPLICABLE",
              "Les présentes conditions sont soumises au droit en vigueur au Sénégal.",
            ),
            
            _buildSection(
              "11. CONTACT",
              "Pour toute question ou réclamation :\n📧 solvable@logersenegal.com\n📞 76 444 33 13",
            ),
