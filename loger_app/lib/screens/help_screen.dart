      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Bienvenue sur Loger Sénégal. Pour vous offrir une expérience sécurisée, voici quelques informations importantes.',
            ...
            _buildFAQItem(
              ...
              'La gestion complète de votre compte, le dépôt d\'annonces et la vérification NILS se font via notre plateforme Web optimisée pour garantir la sécurité des transactions et la véracité des documents.',
            ),
            _buildFAQItem(
            ...
            _buildFAQItem(
              'C\'est quoi la vérification NILS ?',
              'NILS est notre système exclusif de vérification de solvabilité et d\'identité pour protéger locataires et propriétaires contre la fraude.',
            ),
            _buildFAQItem(
            ...
            Center(
              child: ElevatedButton.icon(
                onPressed: () => launchUrl(
                  Uri.parse('https://logersenegal.com/contact/'),
