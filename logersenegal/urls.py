...
from logersn.api import PropertyViewSet, PropertyImageViewSet, ProfessionalsViewSet, BookingViewSet, VisitViewSet, NohanViewSet, BlogPostViewSet
...
router.register(r'nohan', NohanViewSet, basename='api-nohan')
